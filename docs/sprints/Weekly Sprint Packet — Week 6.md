...
* [ ] Test whether the backend server starts without errors
* [ ] Test whether frontend can connect to backend successfully
* [ ] Test whether item posting form data is sent and received correctly
* [ ] Test whether invalid or empty inputs are blocked by validation
* [ ] Test whether user profile dashboard layout displays correctly
* [ ] Test whether chat system UI or basic interaction works
* [ ] Test whether authentication flow works correctly
* [ ] Check browser console for errors
* [ ] Check backend logs for errors
* [ ] Confirm changes are committed and Pull Request is created
